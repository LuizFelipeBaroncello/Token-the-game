...
public class PainelHeroiPerdeuJokenpo extends JPanel{

	private JLabel imagemFundo;
	private JButton botaoOk;
	
	public PainelHeroiPerdeuJokenpo(){
		setLayout(null);
		criaLabelInformacao();
	...
	private void criaLabelInformacao() {
		JLabel informacao = new JLabel("O inimigo ganhou no jokenpo desta vez, por isso vai ataca-lo.");
		informacao.setBounds(320, 145, 500, 24);
		add(informacao);
	}
	
	private void criaTextFieldExibeTurno() {
		JTextField turnoAtual = new JTextField("Turno: Ser atacado");
