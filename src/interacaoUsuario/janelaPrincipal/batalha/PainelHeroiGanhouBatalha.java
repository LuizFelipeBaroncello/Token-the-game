...
public class PainelHeroiGanhouBatalha extends JPanel {

	private JLabel imagemFundo;
	private JButton botaoOk;
	
	public PainelHeroiGanhouBatalha(){
		setLayout(null);
		criaLabelInformacao();
	...
	private void criaLabelInformacao() {
		JLabel informacao = new JLabel("Voce acaba de ganhar a batalha, parabéns.");
		informacao.setBounds(320, 145, 500, 24);
		add(informacao);
	}
	
	private void criaTextFieldExibeTurno() {
		JTextField turnoAtual = new JTextField("Turno: Ganhou");
