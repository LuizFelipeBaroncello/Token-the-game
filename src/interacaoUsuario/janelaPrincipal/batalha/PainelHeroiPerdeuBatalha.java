...
public class PainelHeroiPerdeuBatalha extends JPanel {

	private JLabel imagemFundo;
	private JButton botaoOk;
	
	public PainelHeroiPerdeuBatalha(){
		setLayout(null);
		criaLabelInformacao();
	...
	private void criaLabelInformacao() {
		JLabel informacao = new JLabel("Voce perdeu esta batalha, perderá um ponto de exp por isso.");
		informacao.setBounds(320, 145, 500, 24);
		add(informacao);
	}
	
	private void criaTextFieldExibeTurno() {
		JTextField turnoAtual = new JTextField("Turno: Perdeu");
